...
export const projects: readonly Project[] = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Prototipação de fluxos assistidos por IA com Claude Code",
      "Design do assistente de diagnóstico visual com LLM e visão computacional",
    ...
    context: [
      ...
      "Fui responsável por projetar toda a experiência das features de IA do produto: desde um assistente que preenche prontuários por voz, até um sistema de análise de radiografias que sugere pontos de atenção para o dentista. Usei Claude Code para prototipar interfaces e fluxos diretamente em código, testando com dentistas reais antes de qualquer desenvolvimento formal.",
